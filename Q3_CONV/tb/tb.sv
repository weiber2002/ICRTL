...
`define PAT        "./pattern/cnn_sti.dat"                 // Modify your "dat" directory path
`define L0_EXP0        "./pattern/cnn_layer0_exp0.dat"       
`define L1_EXP0        "./pattern/cnn_layer1_exp0.dat"     
...
if(check1 == 1) begin
	...
	for (p1=0; p1<=1023; p1=p1+1) begin
		if (L1_MEM0[p1] == L1_EXP0[p1]);// $display(err10);
		else begin
			err10 = err10 + 1;
			begin 
...
initial begin
	...
	total_error = err00 + err10;
	err_percent = (total_error * 100.0) / N_EXP; // 計算百分比
	if(err00 == 0 && err10 == 0) begin
		$display("------------------------------------------------");
