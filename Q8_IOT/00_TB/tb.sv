...
`endif
   ...
   initial	 $readmemh ("./00_TB/pattern1.dat", pat_mem);

`ifdef F2
   initial begin $readmemh ("./00_TB/f2.dat",  f2_mem); fn_sel=3'd2;  end
`elsif F3
   initial begin $readmemh ("./00_TB/f3.dat",  f3_mem); fn_sel=3'd3;  end
`elsif F4
   initial begin $readmemh ("./00_TB/f4.dat",  f4_mem); fn_sel=3'd4;  end
`elsif F5
   initial begin $readmemh ("./00_TB/f5.dat",  f5_mem); fn_sel=3'd5;  end
`elsif F6
   initial begin $readmemh ("./00_TB/f6.dat",  f6_mem); fn_sel=3'd6;  end
`elsif F7
   initial begin $readmemh ("./00_TB/f7.dat",  f7_mem); fn_sel=3'd7;  end
`else //F1
   initial begin $readmemh ("./00_TB/f1.dat",  f1_mem); fn_sel=3'd1;  end
`endif
