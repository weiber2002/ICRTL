######################## RTL Simulation ########################
#vcs license 
#vcs -full64 -R +v2k -sverilog ./tb/tb.sv ./ref_solution/initial_island_1.sv -debug_access+all +lint=TFIPC-L | tee rtl_$1.log   
#iverilog 
iverilog -g2012 -o a.out ./tb/tb.sv ./ref_solution/initial_island_1.sv 
vvp a.out | tee ./result/latency.log
########################  Synthesis ############################
yosys -p "
  read_verilog ./ref_solution/initial_island_1.sv;
  hierarchy -top huffman;
