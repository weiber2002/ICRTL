        ...
        case(state_r)
            LOADING: begin
                if(tile_en) begin
                    ...
                    case(load_num_r)
                    0: begin
                        tileA_w[0] = tileA_data_0;
                        tileA_w[1] = tileA_data_1;
                        tileA_w[2] = tileA_data_2;
                        tileA_w[3] = tileA_data_3;
                        tileB_w[0] = tileB_data_0;
                        tileB_w[8] = tileB_data_1;
                        tileB_w[16] = tileB_data_2;
                        tileB_w[24] = tileB_data_3;
                    end
                    1: begin
                        tileA_w[8] = tileA_data_0;
                        tileA_w[9] = tileA_data_1;
                        tileA_w[10] = tileA_data_2;
                        tileA_w[11] = tileA_data_3;
                        tileB_w[1] = tileB_data_0;
                        tileB_w[9] = tileB_data_1;
                        tileB_w[17] = tileB_data_2;
                        tileB_w[25] = tileB_data_3;
                    end
                    2: begin
                        tileA_w[16] = tileA_data_0;
                        tileA_w[17] = tileA_data_1;
                        tileA_w[18] = tileA_data_2;
                        tileA_w[19] = tileA_data_3;
                        tileB_w[2] = tileB_data_0;
                        tileB_w[10] = tileB_data_1; 
                        tileB_w[18] = tileB_data_2;
                        tileB_w[26] = tileB_data_3;
                    end
                    3: begin
                        load_num_w = 0;
                        tileA_w[24] = tileA_data_0;
                        tileA_w[25] = tileA_data_1;
                        tileA_w[26] = tileA_data_2;
                        tileA_w[27] = tileA_data_3;
                        tileB_w[3] = tileB_data_0;
                        tileB_w[11] = tileB_data_1; 
                        tileB_w[19] = tileB_data_2;
                        tileB_w[27] = tileB_data_3;
                    end
                    endcase
                end
            end
