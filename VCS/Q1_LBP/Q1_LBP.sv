...
reg [7:0] buffer [8:0];
wire [8:0] diff0 = {1'b0, buffer[0]} - {1'b0, buffer[4]};
wire [8:0] diff1 = {1'b0, buffer[1]} - {1'b0, buffer[4]};
wire [8:0] diff2 = {1'b0, buffer[2]} - {1'b0, buffer[4]};
wire [8:0] diff3 = {1'b0, buffer[3]} - {1'b0, buffer[4]};
wire [8:0] diff4 = {1'b0, buffer[5]} - {1'b0, buffer[4]};
wire [8:0] diff5 = {1'b0, buffer[6]} - {1'b0, buffer[4]};
wire [8:0] diff6 = {1'b0, buffer[7]} - {1'b0, buffer[4]};
wire [8:0] diff7 = {1'b0, buffer[8]} - {1'b0, buffer[4]};
