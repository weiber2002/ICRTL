...
for ri in $(seq 2 15); do
    ...
    echo "=================================================="
    iverilog -g2012 -o a.out ./ref_solution/sqrt.v ./ref_solution/div.v ./ref_solution/initial.sv ./00_TB/tb.sv -DRI=${ri}
    vvp a.out
done
# ########################  Synthesis ############################
...
yosys -p "
  read_verilog -sv ./ref_solution/sqrt.v ./ref_solution/div.v ./ref_solution/initial.sv;
  hierarchy -top TOP;
