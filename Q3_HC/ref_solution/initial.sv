...
module TOP(clk, rst, gray_data, gray_valid, CNT_valid, CNT1, CNT2, CNT3, CNT4, CNT5, CNT6,
    ...
    assign M1 = 255 >> (8-M_array[1]);
    assign M2 = 255 >> (8-M_array[2]);
    assign M3 = 255 >> (8-M_array[3]);
    assign M4 = 255 >> (8-M_array[4]);
    assign M5 = 255 >> (8-M_array[5]);
    assign M6 = 255 >> (8-M_array[6]);

    always@(*) begin
        HC1 = HC_array[1] >> (8-M_array[1]);
        HC2 = HC_array[2] >> (8-M_array[2]);
        HC3 = HC_array[3] >> (8-M_array[3]);
        HC4 = HC_array[4] >> (8-M_array[4]);
        HC5 = HC_array[5] >> (8-M_array[5]);
        HC6 = HC_array[6] >> (8-M_array[6]);
    end
